...
class QNAYourAnswer_Buying_Test(MessageHandlerTest):
    fixtures = [
    ...
    def choose_non_choice(self, input):
        ...
        self.assert_value(
            datas.QNA__YOUR_ANSWER__INVALID_CHOICE__STRING,
            value_string=input
        )
    ...
    def test_choose_answer(self):
        ...
        self.assert_value(
            ...
            value_string=datas.QNA__YOUR_ANSWER__OPTION__ASK_QUESTION
        )
    ...
    def test_choose_buy_contact(self):
        ...
        self.assert_value(
            datas.QNA__YOUR_ANSWER__OPTION__CHOICE,
            value_string=datas.QNA__YOUR_ANSWER__OPTION__BUY_CONTACT
        )
    ...
    def test_choose_stop_discussion(self):
        ...
        self.assert_value(
            datas.QNA__YOUR_ANSWER__OPTION__CHOICE,
            value_string=datas.QNA__YOUR_ANSWER__OPTION__STOP_DISCUSSION
        )

class QNAYourAnswer_Selling_Test(MessageHandlerTest):
    fixtures = [
        'setup/20210528__payments__currency.json'
    ]
...
class QNAYourAnswer_MatchClosed_Test(MessageHandlerTest):
    def setUp(self):
        super().setUp(
            intents.QNA,
            messages.YOUR_ANSWER
