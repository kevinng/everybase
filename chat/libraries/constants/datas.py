...
DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__DEMAND__ID = 'DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__DEMAND__ID' # Demand ID
DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__SUPPLY__ID = 'DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__SUPPLY__ID' # Demand ID
...
# QNA__YOUR_QUESTION__BUYING__BOOLEAN = 'QNA__YOUR_QUESTION__BUYING__BOOLEAN' # Buying boolean # THIS IS ALSO IN QUESTION
# QNA__YOUR_QUESTION__CURRENCY__STRING = 'QNA__YOUR_QUESTION__CURRENCY__STRING' # Currency string
# QNA__YOUR_QUESTION__PRICE__STRING = 'QNA__YOUR_QUESTION__PRICE__STRING' # Price string
# QNA__YOUR_QUESTION__PAYMENT_URL__STRING = 'QNA__YOUR_QUESTION__PAYMENT_URL__STRING' # Payment URL string
# Why don't I just enter the payment hash ID? I cal insert the currency, price and link, I already have buying
# With the match ID I can also ascertain if the user is buying and selling actually...
...
choices = [
    ...
    (DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__DEMAND__ID, DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__DEMAND__ID),
    (DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__SUPPLY__ID, DISCUSS_W_BUYER__DISCUSS__CONFIRM_INTEREST__SUPPLY__ID),
