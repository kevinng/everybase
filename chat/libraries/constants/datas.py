...
TODO: I do not need keys to identify with intent and message, this lets me reduce the number of keys required

Context-specific data keys are prefixed with the context - intent, message - in
which they are captured, and postfixed by its type. I.e.,

<Intent Key>__<Message Key>__<Data Name>__<Data Type/Choice>

E.g.,

NEW_SUPPLY__SUPPLY__GET_PRODUCT__PRODUCT_TYPE__STRING

Cross-context data keys are prefixed with the generic no-intent, no-message
context keys. E.g.,

NO_INTENT__NO_MESSAGE__MATCH_ID__ID
"""
# TODO: I don't need data keys to encompass the intent and the message
# TODO: if I don't need them to be unique to each intent/message, I can share code
...
# Current Q&A under discussion
# NO_INTENT__NO_MESSAGE__QNA_ID__ID = 'NO_INTENT__NO_MESSAGE__QNA_ID__ID'
...
# Connect Question, Please Pay
# CONNECT_QUESTION__PLEASE_PAY__STRAY_INPUT__STRING = 'CONNECT_QUESTION__PLEASE_PAY__STRAY_INPUT__STRING' # Stray input string

# Connect Answer, Please Pay
# CONNECT_ANSWER__PLEASE_PAY__STRAY_INPUT__STRING = 'CONNECT_ANSWER__PLEASE_PAY__STRAY_INPUT__STRING' # Stray input string
...
# Q&A, Question
# QNA__QUESTION__QUESTION__STRING = 'QNA__QUESTION__QUESTION__STRING' # Question string
...
choices = [
    ...
    # (CONNECT_QUESTION__PLEASE_PAY__STRAY_INPUT__STRING, CONNECT_QUESTION__PLEASE_PAY__STRAY_INPUT__STRING),
    # (CONNECT_ANSWER__PLEASE_PAY__STRAY_INPUT__STRING, CONNECT_ANSWER__PLEASE_PAY__STRAY_INPUT__STRING),
    ...
    # (QNA__QUESTION__QUESTION__STRING, QNA__QUESTION__QUESTION__STRING)
]