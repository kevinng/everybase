...
urlpatterns = [
    ...
    path('conversation_video_status/',
        views.ConversationVideoStatusList.as_view()),
    path('conversation_video_status/<int:pk>/',
        views.ConversationVideoStatusDetail.as_view()),
]
